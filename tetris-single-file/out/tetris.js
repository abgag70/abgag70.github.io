/*  Simple single‑file Tetris – TypeScript 4.x+, ES2015 output
    author: ChatGPT • public domain / CC‑0
*/
const COLS = 10;
const ROWS = 20;
...
class Tetris {
    ...
    collide(shape, offX, offY) {
        var _a, _b;
        for (let y = 0; y < shape.length; ++y) {
            for (let x = 0; x < shape[y].length; ++x) {
                if (shape[y][x] !== 0 &&
                    ((_b = (_a = this.board[y + offY]) === null || _a === void 0 ? void 0 : _a[x + offX]) !== null && _b !== void 0 ? _b : 1) !== 0) {
                    return true;
                }
            }
        }
